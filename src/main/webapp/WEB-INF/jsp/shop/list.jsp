		...
		<div class="row">
			<c:forEach var="row" items="${items }">
				<div class="col-lg-4 col-md-4 col-sm-4 bottom-space">
					<div class="card">
						<a href="${path }/shop/${row.iid}"><img class="card-img-top" src="${path}/img/${row.img}" width="300px" height="300px"></a>
						<div class="card-body">
							<h5 class="card-title"><a href="${path }/shop/${row.iid}">${row.name }</a></h5>
							<p class="card-text text-right"><a href="${path }/shop/${row.iid}">$${row.price }</a></p>
						</div>
					</div>
				</div>
			</c:forEach>
